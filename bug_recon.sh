...
#   Platform: Kali Linux
#   Usage: sudo bash bug_recon.sh -d target.com [OPTIONS]
# ============================================================
...
cat << 'EOF'
 ____               ____                      
| __ ) _   _  __ _ |  _ \ ___  ___ ___  _ __  
|  _ \| | | |/ _` || |_) / _ \/ __/ _ \| '_ \ 
| |_) | |_| | (_| ||  _ <  __/ (_| (_) | | | |
|____/ \__,_|\__, ||_| \_\___|\___\___/|_| |_|
             |___/                            
EOF
echo -e "${NC}"
echo -e "${MAGENTA}${BOLD}==========================================================================${NC}"
echo -e "  ${CYAN}${BOLD}Bug Recon${NC} ${WHITE}-${NC} ${YELLOW}Automated Bug Bounty Recon Toolkit${NC}"
echo -e "  ${WHITE}Author   :${NC} ${CYAN}Elilan Baskaran${NC}"
echo -e "  ${WHITE}Repo     :${NC} ${CYAN}github.com/BaskaranElilan/Bug-Recon${NC}"
...
echo -e "  ${YELLOW}TIP   :${NC}  ${WHITE}Enumeration is the key - the more you find, the more you can validate.${NC}"
echo -e ""
}
# --- LOGGING ─────────────────────────────────────────────────
LOG_FILE=""
...
cat << EOF
${BOLD}USAGE:${NC}
    sudo bash bug_recon.sh -d target.com [OPTIONS]
...
${BOLD}EXAMPLES:${NC}
    ...
    sudo bash bug_recon.sh -d example.com --fresh   # force new scan
...
phase_ferox_all() {
    ...
    # This is the consolidated endpoint file for manual analysis.
    ...
    log "   (Use this for manual analysis and Burp Suite import)"
    log "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
main() {
    ...
    if [[ "$INSTALL_ONLY" == true ]]; then
        check_and_install
        log "All tools installed. Run recon with: sudo bash bug_recon.sh -d target.com"
        exit 0
    fi
